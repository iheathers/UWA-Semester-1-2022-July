...
def list_of_min_max_distances(grouped_expression_rows_for_id):
    ...
    for i in range(1, 9):
        min_max_distances_for_distance_name = min_max_distances_for_each_distance_name(i, grouped_expression_rows_for_id)
...
def list_of_distance_difference_for_all_expressions(grouped_expression_rows_for_id):
    ...
    for expression in expressions:
        distance_difference_for_exp = list_of_distance_difference_for_expression(expression, grouped_expression_rows_for_id)
...
def list_of_average_gdis_distances(grouped_expression_rows_for_id):
    ...
    for i in range(1, 9):
        gdis_distances_for_distance_name = list_of_distances_for_distance_name(i, 'g_dis', grouped_expression_rows_for_id)
...
def list_of_standard_deviation_for_distance_name(grouped_expression_rows_for_id):
    ...
    for i in range(1, 9):
        ldis_distances_for_distance_name = list_of_distances_for_distance_name(i, 'l_dis', grouped_expression_rows_for_id)
        standard_deviation_of_ldis_distances_for_distance_name = standard_deviation_of_list(ldis_distances_for_distance_name)
        standard_deviations_of_ldis_distances_for_distance_name.append(standard_deviation_of_ldis_distances_for_distance_name)
...
def cosine_similarity(neutral_distances, exp_gdis_distances):
    ...
    cos_sim = sum_of_products / (square_root(sum_of_squares_of_neutral_distances) * square_root(sum_of_squares_of_exp_gdis_distances))
...
def list_of_ids_and_cos_sim(neutral_expression_rows_for_id, expression_rows_for_comparison):
    ...
    for i in range(0, len(expression_rows_for_comparison), 8):
        ...
        gdis_distances_for_same_id_and_expression = list_of_gdis_distances(grouped_expression_rows_with_same_id_and_expression)
...
def main(csvfile, adultID, Option):
    ...
    with open(csvfile) as filein:
        ...
        csv_expression_rows = raw_data.split(NEWLINE)[1:]
    ...
    if Option.upper() == FR_OPTION:
        ...
        non_neutral_expression_rows_for_id = list_of_non_neutral_expression_rows_for_id(adultID, grouped_expression_rows)
        neutral_expression_rows_for_non_selected_ids = list_of_neutral_expression_rows_for_non_selected_ids(adultID, grouped_expression_rows)

        expression_rows_for_comparison = non_neutral_expression_rows_for_id + neutral_expression_rows_for_non_selected_ids

        list_of_gdis_cosine_sims = list_of_ids_and_cos_sim(neutral_expression_rows_for_id, expression_rows_for_comparison)
